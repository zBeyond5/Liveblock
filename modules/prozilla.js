(function() {
    ...
    win.id = UID;
    win.innerHTML = `
        <div class="osl-hdr" id="${UID}hdr"><span>prozilla — ProzillaOS</span><span class="osl-close" id="${UID}close">✕</span></div>
        <iframe src="${OS_URL}" allow="clipboard-read; clipboard-write" sandbox="allow-scripts allow-same-origin allow-forms allow-popups"></iframe>
    `;
